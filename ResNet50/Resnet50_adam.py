...
model, train_losses, val_losses, train_accuracies, val_accuracies = train_model(resnet50, train_loader, val_loader, optimizer, criterion, n_epochs, early_stopping)
print("Training Complete", flush=True)

torch.save(model.state_dict(), 'plant_village_resnet50_model.pth')
...
plt.legend()
plt.tight_layout()
plt.savefig('loss_plot_resnet50.png') 
plt.show()
...
plt.ylabel('Accuracy')
plt.legend()
plt.savefig('accuracy_plot_resnet50.png')
plt.show()
...
plt.tight_layout()
plt.savefig('confusion_matrix_resnet50.png', bbox_inches='tight')  
plt.show()
