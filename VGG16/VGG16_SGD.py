...
features.extend([nn.Linear(num_features, len(train_dataset.classes))])  
...
model, train_losses, val_losses, train_accuracies, val_accuracies = train_model(vgg16, train_loader, val_loader, optimizer, criterion, n_epochs, early_stopping, scheduler=scheduler)
print("Training Complete", flush=True)

torch.save(model.state_dict(), 'plant_village_vgg16_SGD_model.pth')
...
plt.legend()
plt.tight_layout()
plt.savefig('loss_plot_vgg16_SGD.png')  
plt.show()
...
plt.ylabel('Accuracy')
plt.legend()
plt.savefig('accuracy_plot_VGG16_SGD.png')
plt.show()
...
plt.tight_layout()
plt.savefig('confusion_matrix_VGG16_SGD.png', bbox_inches='tight') 
plt.show()
