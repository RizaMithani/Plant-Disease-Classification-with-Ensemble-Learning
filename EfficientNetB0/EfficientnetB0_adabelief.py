...
torch.save(model.state_dict(), 'plant_village_efficientnet_ada_model.pth')
...
plt.legend()
plt.tight_layout()
plt.savefig('loss_plot_efficientnet_ada.png') 
plt.show()
...
plt.ylabel('Accuracy')
plt.legend()
plt.savefig('accuracy_plot_efficientnet_ada.png')
plt.show()
...
plt.tight_layout()
plt.savefig('confusion_matrix_efficientnet_ada.png', bbox_inches='tight')  
plt.show()
