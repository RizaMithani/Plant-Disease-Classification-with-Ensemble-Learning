...
class EarlyStopping:
    ...
    def save_checkpoint(self, val_loss, model):
        ...
        torch.save(model.state_dict(), 'checkpoint_esgd.pt')
...
torch.save(model.state_dict(), 'plant_village_efficientnet_SGD_model.pth')
...
plt.legend()
plt.tight_layout()
plt.savefig('loss_plot_efficientnet_SGD.png')  
plt.show()
...
plt.ylabel('Accuracy')
plt.legend()
plt.savefig('accuracy_plot_efficientnet_SGD.png')
plt.show()
...
plt.tight_layout()
plt.savefig('confusion_matrix_efficientnet_SGD.png', bbox_inches='tight') 
plt.show()
