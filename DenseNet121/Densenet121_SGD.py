...
class EarlyStopping:
    ...
    def save_checkpoint(self, val_loss, model):
        ...
        torch.save(model.state_dict(), 'checkpoint_dsgd.pt')
...
torch.save(model.state_dict(), 'plant_village_densenet_SGD_model.pth')
...
plt.legend()
plt.tight_layout()
plt.savefig('loss_plot_densenet_SGD.png')  
plt.show()
...
plt.ylabel('Accuracy')
plt.legend()
plt.savefig('accuracy_plot_densenet_SGD.png')
plt.show()
...
plt.tight_layout()
plt.savefig('confusion_matrix_densenet_SGD.png', bbox_inches='tight')  
plt.show()
