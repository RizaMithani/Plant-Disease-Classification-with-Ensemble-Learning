...
torch.save(model.state_dict(), 'plant_village_densenet_dada_model.pth')
...
plt.legend()
plt.tight_layout()
plt.savefig('loss_plot_densenet_ada.png')  
...
plt.ylabel('Accuracy')
plt.legend()
plt.savefig('accuracy_plot_densenet_ada.png')
plt.show()
...
plt.tight_layout()
plt.savefig('confusion_matrix_densenet_ada.png', bbox_inches='tight')  
plt.show()
